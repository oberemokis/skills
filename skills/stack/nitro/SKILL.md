...
Версия: `nitropack@2.13.4` с `h3@1.15.11`, внутри Nuxt 4.4.6. Имена всех функций ниже сверены с типами установленных пакетов, а не взяты по памяти.
...
Серверных роутов в проектах пока нет, каталог `server/` не создан. Значит соглашений, выведенных из кода, здесь тоже нет, и правила ниже держатся на документации и на типах пакета.
